<template>
  <view class="order-submission">
    ...
    <view class="footer acea-row row-between-wrapper">
      ...
      <!--  -->
	  <view class="settlement" v-if="orderPrice.totalPrice >= 30" @click="createOrder">立即结算</view>
	  <view class="settlement disabled" v-if="orderPrice.totalPrice < 30" @click="showError">满￥30起送哦</view>
    </view>
